        ...
        <header>
                ...
                <div>
                    <ul class="d-flex">
                        ...
                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="nav-link dropdown-toggle no-after" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                {{ Auth::user()->name }}
                            </a>
            ...
            <div class="nav-section2 py-2 opacity-25">
                <ul class="container d-flex">
                    <li><a class="pl-4 text-capitalize fs-4" href="/">home</a></li>
                    <li><a class="pl-4 text-capitalize fs-4" href="/">about</a></li>
                    <li><a class="pl-4 text-capitalize fs-4" href="{{route('contact.create')}}">contact</a></li>
                </ul>
            </div>
            @yield('search')
        </header>
            ...
            <div class="footer-section1 py-4 d-flex justify-content-around ">
                ...
                <div class="Newsletter">
                    ...
                    <div class="social-media-links pt-2">
                        ...
                        <ul class="d-flex">
                            <li><a href="https://www.facebook.com"><i class="bi bi-facebook pr-4"></i></a></li>
                            <li><a href="https://www.twitter.com"><i class="bi bi-twitter pr-4"></i></a></li>
                            <li><a href="https://www.instagram.com"><i class="bi bi-instagram pr-4"></i></a></li>
                            <li><a href="https://www.linkedin.com"><i class="bi bi-linkedin pr-4"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
